...
import { RvComponent } from 'app/entities/rv/rv.component';
import { RvService } from 'app/entities/rv/rv.service';
import { Rv } from 'app/shared/model/rv.model';

describe('Component Tests', () => {
  describe('Rv Management Component', () => {
    let comp: RvComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rvs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
