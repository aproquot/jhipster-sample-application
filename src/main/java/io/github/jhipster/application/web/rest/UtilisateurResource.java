...
import io.github.jhipster.application.repository.UtilisateurRepository;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Utilisateur}.
 */
@RestController
@RequestMapping("/api")
